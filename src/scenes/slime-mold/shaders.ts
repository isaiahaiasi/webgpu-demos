function getComputeShader(renderer: any) {
  return /*wgsl*/`
...
function getRenderShader(p0: { scaleX: number; scaleY: number; width: number; height: number }) {
  return /*wgsl*/`// Consts prepended in JavaScript:
// SCALE_X : f32
// SCALE_Y : f32
